...
<table align="center" style="width:800px; line-height:40px; border: 1px solid #ddd;">
      <tr>
        <th colspan="4" style="background-color:lightgreen; text-align:center;"><h3>Own Projects</h3></th>  
      </tr>
      <tr>
      ...
      <?php
        while($rows=$result_project->fetch(PDO::FETCH_ASSOC)){
            ...
            <td style=\"padding:12px; border: 1px solid #ddd;\"><a href = 'fixmeeting.php?rn=$rows[id]'>Details</td>
            </tr>
            ";
        }
        ?>      
  ...
  <table align="center" style="width:800px; line-height:40px; border: 1px solid #ddd;">
      <tr>
        <th colspan="4" style="background-color:#81d8d0; text-align:center;"><h3>Invited Projects</h3></th>  
      </tr>
      <tr>
        <th style="padding:12px; border: 1px solid #ddd;">Project Name</th>
        <th style="padding:12px; border: 1px solid #ddd;">Project Type</th>
      ...
      <?php
        while($rows=$result_display_invited_projects->fetch(PDO::FETCH_ASSOC)){
            ...
            <td style=\"padding:12px; border: 1px solid #ddd;\">".$rows['projectname']."</td>
            <td style=\"padding:12px; border: 1px solid #ddd;\">".$rows['projecttype']."</td>
            <td style=\"padding:12px; border: 1px solid #ddd;\"><a href = 'fixmeeting.php?rn=$rows[projectid]'>Details</td>
            </tr>
            ";
        }
        ?>      
