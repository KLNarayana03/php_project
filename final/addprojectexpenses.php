...
<?php if(!isset($_SESSION['username'])): header("location: logout.php");?>
  ...
  <div class="maincontent">
    <button class="topbutton">Add Expenses</button>
    <hr class="new1">
    ...
    <select style="width: 20.9%; padding: 15px; margin: 5px 0 22px 0; border: none; background: #f1f1f1;" for="expensetype" id="expensetype" name="expensetype" style="margin-bottom:20px;">
    ...
    <table style="width:95%; border: 1px solid #ddd;">
      <tr style="background-color:lightblue;">
        <th colspan="4" style="text-align:center;"><h3>Expenses Made </h3></th>  
      </tr>
      <tr>
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">S.No</th>
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">Expense Type</th>
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">Amount</th>
      ...
      <?php
        while($rows=$result_display_projectexpenses->fetch(PDO::FETCH_ASSOC)){
            ...
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\">".$rows['expensetype']."</td>
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\">".$rows['billamount']."</td>
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\"><a href = 'projectexpensesdetails.php?rn=$rows[id]'>details</td>
            </tr>
            ";
            $sno++;
        }
