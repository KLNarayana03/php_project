...
<?php if(!isset($_SESSION['username'])): header("location: logout.php");?>
    ...
    <table align="center" style="width:800px; line-height:40px; border: 1px solid #ddd;">
      ...
      <tr>
        <th style="text-align:center; padding:5px; border: 1px solid #ddd;">Project Name</th>
        <th style="text-align:center; padding:5px; border: 1px solid #ddd;">Project Type</th>
        <th style="text-align:center; padding:5px; border: 1px solid #ddd;">Assign Task in this project</th>
      </tr>
      <?php
