...
$result_display_deleted =$conn->prepare($query);
$result_display_deleted->execute();
...
<?php if(!isset($_SESSION['username'])): header("location: logout.php");?>
    ...
    <table style="width:95%; border: 1px solid #ddd; margin-left:15px;">
      ...
      <tr>
        ...
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">Project Description</th>
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">Restore</th>
        <th style="padding:5px; border: 1px solid #ddd; text-align:center;">Delete Permanently</th>
      </tr>
      <?php
        while($rows=$result_display_deleted->fetch(PDO::FETCH_ASSOC)){
            echo "
            <tr>
            ...
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\">".$rows['projectdesc']."</td>
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\"><a href = 'restore.php?rn=$rows[id]' onclick=\"return confirm('Sure to Restore?')\">Restore</a></td>
            <td style=\"padding:5px; text-align:center; border: 1px solid #ddd;\"><a href = 'deletepermanent.php?rn=$rows[id]' onclick=\"return confirm('Are you sure?')\">Delete</a></td>
            </tr>
            ";
            $sno++;
        }
